...
var model = function(options, language) {
    // this === request
    var pageheaderPromise = fsMD.readFile('../markdowns/'+language+'/client-model-header.MD');
    var pagecontentPromise = fsMD.readFile('../markdowns/'+language+'/client-model-content.MD');
