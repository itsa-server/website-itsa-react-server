                ...
                <div className="main">
                    <div className="splash-container">
                        <div className="splash">
                            ...
                            <p>
                                <a href="https://github.com/itsa-server/itsa-cli/archive/master.zip" className="pure-button pure-button-primary">Download cli</a>
                                <a href="https://github.com/ItsAsbreuk/website-itsa-react-server" className="pure-button pure-button-primary">{this.props.messages.viewthis} website-code</a>
                            </p>
                        </div>
                    </div>
                    <div className="content-wrapper">
                        ...
                        <div className="footer l-box is-center">
                            Marco Asbreuk, Itsa react-server {this.props.messages.licenced} <a href="http://choosealicense.com/licenses/bsd-3-clause/">New BSD License</a>
                        </div>
                    </div>
                </div>
            </div>
