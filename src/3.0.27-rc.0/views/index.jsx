                ...
                <div className="main">
                    <div className="splash-container">
                        <div className="splash">
                            ...
                            <p>
                                <a href="https://www.npmjs.com/package/itsa-cli" className="pure-button pure-button-primary">{this.props.messages.install} itsa-cli 2.4.17</a>
                                <a href="https://github.com/itsa-server/website-itsa-react-server/tree/master/src/3.0.26-rc.0" className="pure-button pure-button-primary">{this.props.messages.viewthis} website-code</a>
                            </p>
                        </div>
                    </div>
