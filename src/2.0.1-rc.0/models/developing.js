...
var model = function(options, language) {
    // this === request
    var pageheaderPromise = fsMD.readFile('../markdowns/'+language+'/developing-header.MD');
    var pagecontentPromise = fsMD.readFile('../markdowns/'+language+'/developing-content.MD');
