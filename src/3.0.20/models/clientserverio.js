...
var model = function(options, language) {
    // this === request
    var pageheaderPromise = fsMD.readFile('../markdowns/'+language+'/client-server-io-header.MD');
    var pagecontentPromise = fsMD.readFile('../markdowns/'+language+'/client-server-io-content.MD');
