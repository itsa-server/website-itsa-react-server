...
var model = function(options, language) {
    // this === request
    var pageheaderPromise = fsMD.readFile('../markdowns/'+language+'/production-header.MD');
    var pagecontentPromise = fsMD.readFile('../markdowns/'+language+'/production-content.MD');
