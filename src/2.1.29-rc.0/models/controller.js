...
var model = function(options, language) {
    // this === request
    var pageheaderPromise = fsMD.readFile('../markdowns/'+language+'/controller-header.MD');
    var pagecontentPromise = fsMD.readFile('../markdowns/'+language+'/controller-content.MD');
