...
var model = function(options, language) {
    // this === request
    var pageheaderPromise = fsMD.readFile('../markdowns/'+language+'/configuration-header.MD');
    var pagecontentPromise = fsMD.readFile('../markdowns/'+language+'/configuration-content.MD');
