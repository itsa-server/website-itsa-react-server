!function(e) {
    ...
    (function(e) {
        "use strict";
        var t = n(36), o = n(350), r = n(373), a = t.createClass({
    ...
    "use strict";
    n(180), n(354);
    var o = n(36), r = n(71), a = n(179), i = n(178), s = [ "installation", "configuration" ], u = [ "pages", "models", "async-models", "client-model", "actions", "controller", "router", "appfile", "different-devices", "markdown", "i18n", "databases" ], c = [ "developing", "production", "gulp" ], l = "pure-menu-", p = l + "link", d = l + "item", f = l + "heading", h = l + "list", m = " " + l + "selected", v = o.createClass({
        displayName: "Menu",
        mixins: [ r.connect(a) ],
        render: function() {
    ...
    "use strict";
    n(181), n(382), n(381), n(355), n(380);
    var o = n(36), r = n(352), a = n(351), i = n(71), s = n(179), u = n(383), c = o.createClass({
        displayName: "Body",
        mixins: [ i.connect(s) ],
        render: function() {
            ...
            }, this.props.messages.install, " cli"), o.createElement("a", {
                href: "https://github.com/itsa-server/website-itsa-react-server/tree/master/src/3.0.3",
                className: "pure-button pure-button-primary"
