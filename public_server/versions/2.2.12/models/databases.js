...
var model = function(options, language) {
    // this === request
    var pageheaderPromise = fsMD.readFile('../markdowns/'+language+'/databases-header.MD');
    var pagecontentPromise = fsMD.readFile('../markdowns/'+language+'/databases-content.MD');
