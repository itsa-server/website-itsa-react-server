webpackJsonp([ 2 ], {
    26: function(e, t, n) {
        ...
        var l = n(222), a = n(469), s = n(468), c = n(443), o = n(452), i = l.createClass({
            displayName: "Body",
            mixins: [ c.connect(o) ],
            render: function() {
    ...
    442: function(e, t, n) {
        "use strict";
        var r = n(441), l = n(450).instanceJoinCreator, a = function(e) {
    ...
    449: function(e, t, n) {
        "use strict";
        var r = n(441), l = n(444), a = n(462), s = n(459), c = {
            preEmit: 1,
            shouldEmit: 1
        };
    ...
    451: function(e, t, n) {
        "use strict";
        var r, l = n(443), a = n(470);
        r = [ a.TOGGLE_MENU ], e.exports = l.createActions(r);
    },
    452: function(e, t, n) {
        "use strict";
        var r, l = n(443), a = n(451), s = n(455), c = l.createStore({
            mixins: [ s ],
            listenables: [ a ],
    ...
    455: function(e, t, n) {
        (function(t) {
            "use strict";
            var r, l = "undefined" != typeof t && "[object global]" === {}.toString.call(t) && (!t.document || "[object HTMLDocument]" !== {}.toString.call(t.document)), a = !1, s = l ? {} : window, c = n(457), o = n(456), i = "itsaRefluxClientStorage", m = 3600, u = function(e) {
                if (!a) {
                    a = !0;
                    var t = function(t) {
                ...
                readStateFromClientStorage: function(e, t) {
                    ...
                    if (t ? e = "@" + e : (t = e, e = ""), this.envBrowser() && o) {
                        var a = n(223), s = a.getProps().__sessiontime;
    ...
    460: function(e, t, n) {
        "use strict";
        var r = n(441), l = n(447), a = n(445), s = n(444), c = {
            preEmit: 1,
            shouldEmit: 1
        }, o = function i(e) {
            e = e || {}, r.isObject(e) || (e = {
    ...
    467: function(e, t, n) {
        "use strict";
        var r = n(222), l = "pure-menu-list", a = "pure-menu-item", s = "pure-menu-selected", c = "pure-menu-link", o = r.createClass({
    ...
    468: function(e, t, n) {
        "use strict";
        n(453), n(471);
        var r = n(222), l = n(443), a = n(452), s = n(451), c = [ "installation", "configuration" ], o = [ "pages", "models", "async-models", "client-model", "actions", "controller", "router", "appfile", "different-devices", "markdown", "i18n", "databases" ], i = [ "developing", "production", "gulp" ], m = "pure-menu-", u = m + "link", d = m + "item", f = m + "heading", p = m + "list", E = " " + m + "selected", h = r.createClass({
            displayName: "Menu",
            mixins: [ l.connect(a) ],
            render: function() {
    ...
    469: function(e, t, n) {
        "use strict";
        n(453), n(454), n(473);
        var r = n(467), l = n(222), a = [ "/" ], s = n(474), c = l.createClass({
            displayName: "Menu",
            render: function() {
                var e = {}, t = {}, n = this;
