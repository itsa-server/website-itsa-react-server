!function(e) {
    ...
    var n = {};
    return t.m = e, t.c = n, t.p = "assets/3.0.11/", t(0);
}(function(e) {
    ...
    (function(e) {
        "use strict";
        var t = n(36), r = n(350), o = n(378), a = t.createClass({
    ...
    "use strict";
    n(180), n(354);
    var r = n(36), o = n(71), a = n(179), i = n(178), s = [ "installation", "configuration" ], u = [ "pages", "models", "async-models", "client-model", "actions", "controller", "router", "appfile", "different-devices", "markdown", "i18n", "databases" ], l = [ "developing", "production", "gulp" ], c = "pure-menu-", p = c + "link", d = c + "item", f = c + "heading", h = c + "list", m = " " + c + "selected", v = r.createClass({
        displayName: "Menu",
        mixins: [ o.connect(a) ],
        render: function() {
